        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="<?php echo base_url(); ?>#revenue-chart" data-toggle="tab">Area</a></li>
              <li><a href="<?php echo base_url(); ?>#sales-chart" data-toggle="tab">Donut</a></li>
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <div class="item">
                ...
                <p class="message">
                  <a href="<?php echo base_url(); ?>#" class="name">
              ...
              <div class="pull-right box-tools">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="<?php echo base_url(); ?>#">Add new event</a></li>
                    <li><a href="<?php echo base_url(); ?>#">Clear events</a></li>
                    <li class="divider"></li>
                    <li><a href="<?php echo base_url(); ?>#">View calendar</a></li>
                  </ul>
                </div>
